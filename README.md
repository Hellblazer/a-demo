...
This is the repository of the Sky application, built on the Apollo distributed platform. It's a fantasy POC for a
minimal
viable system built using the modular framework of Apollo.
